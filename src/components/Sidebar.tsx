import { Award, Contact, House, Images, Briefcase, Menu, Code2, Binary, GraduationCap } from "lucide-react";
...
const Sidebar = ({ isCollapsed, setIsCollapsed }: SidebarProps) => {
  const navItems = [
    ...
    { path: "/projects", label: "Projects", icon: Briefcase, tooltip: "My Projects" },
