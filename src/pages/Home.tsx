    ...
    return (
        <>
            <div className="flex flex-col items-center justify-center text-center gap-6 mt-20">
                ...
                <button onClick={downloadResume} className="flex items-center gap-2 px-4 py-2 bg-[#fbbf24] hover:bg-[#f59e0b] text-white font-semibold rounded-md shadow-md hover:shadow-lg transition-shadow duration-300">
