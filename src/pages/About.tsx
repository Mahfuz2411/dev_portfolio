            ...
            <Card className="p-6 text-center border-2 border-slate-200 dark:border-slate-700 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm h-full">
              ...
              <div className="space-y-3 mb-4">
                ...
                <div className="flex items-center justify-center gap-3 text-slate-700 dark:text-slate-300">
                  ...
                  <span className="text-sm">+8801732389350</span>
                </div>
              </div>
            </Card>
          </div>
            ...
            <Card className="p-6 sm:p-8 border-2 border-slate-200 dark:border-slate-700 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm h-full">
              ...
              <div className="space-y-4 text-slate-600 dark:text-slate-300 leading-relaxed">
                {/* <p>
                  ...
                  who loves building creative and functional web applications.
                  My journey in tech started with curiosity and evolved into a
                  deep passion for crafting elegant solutions to complex
                  problems.
                </p>
                <p>
                  My specialty lies in creating{" "}
                  <span className="font-semibold text-purple-600 dark:text-purple-400">
                    interactive web experiences
                  </span>{" "}
                  using modern technologies. I believe in writing clean,
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-3 sm:gap-4">
                    <div
                      className={`shrink-0 w-10 h-10 sm:w-12 sm:h-12 bg-linear-to-br ${item.color} rounded-lg sm:rounded-xl flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300`}
                    >
